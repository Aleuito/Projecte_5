            ...
            if (!teclat.hasNextInt()) {
                ...
                switch (resposta) {
                    ...
                    case 1:
                        ...
                        /*CRIDEM EL METODE cargar_kits I GUARDEM LA INFO EN UN ARRAY BIDIMENSIONAL*/
                        kits = kit.cargar_kit();
                        ...
                        if (!teclat.hasNextInt()) {
                            ...
                            switch (resposta) {
                                case 1:
                                    ...
                                    Esquis[] llistat_esquis = null;
                                    Kits[] cargar_kits = null;
                                    
                                    /*LLISTEM ESQUIS I ELS MOSTREM*/
                                    llistat_esquis=esquis.llistar_esquis();
                                    esquis.mostrar_esquis(llistat_esquis);
                                    ...
                                    cargar_kits = kit.cargar_kit();
                                    
                                    int contador = 0;
                                    /*COMPROVEM EN QUANTS KITS ES TROBA EL MATERIAL*/
                                    for(int x=0; x<cargar_kits.length; x++){
                                        if(cargar_kits[x]!=null){    
                                            if(cargar_kits[x].getEsqui().getId().equals(id_esqui)){
                                                contador++;
                                            } 
                                        }
                                    }
                                    ...
                                    for(int i=0; i<llistat_esquis.length; i++){
                                        if(llistat_esquis[i]!=null){
                                            if(id_esqui.equals(llistat_esquis[i].getId())){
                                                comprovador_esqui++;
                                            }
                                        }
                                    }
                                ...
                                case 2:
                                    ...
                                    Pals[] llistat_pals = null;
                                    Kits[] cargarkits = null;
                                    
                                    /*LLISTEM PALS I ELS MOSTREM*/
                                    llistat_pals=pals.llistar_pals();
                                    pals.mostrar_pals(llistat_pals);
                                    ...
                                    cargarkits = kit.cargar_kit();
                                    
                                    int contador_pals = 0;
                                    
                                    /*COMPROVEM EN QUANTS KITS ES TROBA EL MATERIAL*/
                                    for(int x=0; x<cargarkits.length; x++){
                                        if(cargarkits[x]!=null){    
                                            if(cargarkits[x].getPals().getId().equals(id_pal)){
                                                contador_pals++;
                                            }
                                        }
                                    }
                                    ...
                                    for(int i=0; i<llistat_pals.length; i++){
                                        if(llistat_pals[i]!=null){
                                            if(id_pal.equals(llistat_pals[i].getId())){
                                                comprovador_pals++;
                                            }
                                        }
                                    }
                                ...
                                case 3:
                                    ...
                                    Botes[] llistat_botes = null;
                                    Kits[] cargakits = null;
                                    
                                    /*LLISTEM PALS I ELS MOSTREM*/
                                    llistat_botes=botes.llistar_botes();
                                    botes.mostrar_botes(llistat_botes);
                                    ...
                                    cargakits = kit.cargar_kit();
                                    
                                    int contador_botes = 0;
                                    
                                    /*COMPROVEM EN QUANTS KITS ES TROBA EL MATERIAL*/
                                    for(int x=0; x<cargakits.length; x++){
                                        if(cargakits[x]!=null){    
                                            if(cargakits[x].getBotes().getId().equals(id_bota)){
                                                contador_botes++;
                                            }
                                        }
                                    }
                                    ...
                                    /*COMPROVEM SI EL ID INTRODUIT EXISTEIX*/
                                    int comprovador =0;
                                    for(int i=0; i<llistat_botes.length; i++){
                                        if(llistat_botes[i]!=null){
                                            if(id_bota.equals(llistat_botes[i].getId())){
                                                comprovador++;
                                            }
                                        }
                                    }
                    ...
                    case 4:
                        ...
                        Esquis[] esquiar = new Esquis [100];
                        esquiar = esquis.llistar_esquis();
                        esquis.mostrar_esquis(esquiar);
                        System.out.println();
                        ...
                        Pals[] palos = new Pals [100];
                        palos = pals.llistar_pals();
                        pals.mostrar_pals(palos);
                        System.out.println();
                        ...
                        Botes[] botins = new Botes [100];
                        botins = botes.llistar_botes();
                        botes.mostrar_botes(botins);
                        System.out.println();
                        creacionoubota = botes.crear_bota();
                        
                        /*CREEM EL KIT AMB LES VARIBLES SELECCIONADES PEL CLIENT*/
                        Kits nuevo_kit = new Kits("", creacionouesqui, creacionoubota, creacionoupal);
                    ...
                    try{
                        ...
                        if(sentencia.executeUpdate(consulta)!=0){
                            System.out.println("S'ha creat el KIT correctament.");
                        }else{
                            System.out.println("ERROR: No s'ha pogut crear el seu KIT.");
                        }
